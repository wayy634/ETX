...
#define K_IS_PUBLISH  0
    ...
    #define K_URL_P2P_HOST @"http://pre.p2p.v3.imxiaomai.com"
    #define K_URL_MALL_HOST @"http://pre.app.imxiaomai.com"
    #define K_URL_REWARD_HOST @"http://app.tmall.imxiaomai.com"
    ...
    #define K_URL_P2P_HOST @"http://p2p.test.b2.imxiaomai.com"
    #define K_URL_MALL_HOST @"http://app.tmall.imxiaomai.com"
    #define K_URL_REWARD_HOST @"http://app.tmall.imxiaomai.com"
    #define K_URL_TEN_HOST @"http://apis.map.qq.com"
    #define K_URL_PUSH_HOST @"http://123.57.33.173:8092"
#endif
...
//一些固定的Url地址
#define K_WEBURL_INVATATIONFRIENDS_RULE  @"http://wap.tmall.imxiaomai.com/page/bonus/activityExplain.html"//邀请好友的活动规则
//邀请好友的单日上限
...
#define K_BACK_URL                  [NSString stringWithFormat:@"%@://",[[LTools getAppData] objectAtIndex:5]]//@"xiaomaiiosapp://"
#define K_BACK_URL_SHARE            @"xiaomaiiosapp://"
