...
+ (void)registerThirdpartyPayBaseInfo {
    //向微信注册
    [WXApi registerApp:K_WECHAT_APP_ID withDescription:@"XiaoMai"];
}
...
//        
//    [[AlipaySDK defaultService] payOrder:orderString fromScheme:@"XiaoMaiPay" callback:^(NSDictionary *resultDic) {
