...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _EPDayCellTitle   = [[UILabel alloc] initWithFrame:CGRectMake(50, 10, K_SCREEN_WIDTH-100, 20)];
        _EPDayCellSTime   = [[UILabel alloc] initWithFrame:CGRectMake(50, 30, K_SCREEN_WIDTH-100, 20)];
