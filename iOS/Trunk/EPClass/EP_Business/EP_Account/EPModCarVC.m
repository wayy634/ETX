...
@interface EPModCarVC ()<UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate>
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (row) {
        case 0:
            profileTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"请输入驾驶证编号" attributes:attrsDictionary];
            break;
        case 1:
            profileTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"请输入发动机编号" attributes:attrsDictionary];
            break;
        case 2:
            profileTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"请输入车主真实姓名" attributes:attrsDictionary];
            break;
        case 3:
            profileTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"请输入车牌号码" attributes:attrsDictionary];
            break;
        case 4:
            profileTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"请选择汽车品牌" attributes:attrsDictionary];
            break;
        case 5:
            profileTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"请确认购入时间" attributes:attrsDictionary];
            break;
        default:
            break;
    }
...
- (void)textFieldWithText:(UITextField *)textField
{
    switch (textField.tag) {
        case 0:
            _carDriveNO = textField.text;
            break;
        case 1:
            _carEngineNO = textField.text;
            break;
        case 2:
            _carOwner = textField.text;
            break;
        case 3:
            _carLPN = textField.text;
            break;
        case 4:
            _carCarBrand = textField.text;
            break;
        case 5:
            _carCarBoughtTime = textField.text;
            break;
        default:
            break;
    }
