...
@interface EPModGarageVC ()<UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate>
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (row) {
        case 0:
            profileTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"请输入车库所在小区" attributes:attrsDictionary];
            break;
        case 1:
            profileTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"请输入车库详细地址" attributes:attrsDictionary];
            break;
        case 2:
            profileTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"是否为私有车位" attributes:attrsDictionary];
            break;
        case 3:
            profileTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"车库类型" attributes:attrsDictionary];
            break;
        case 4:
            profileTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"是否愿意出租" attributes:attrsDictionary];
            break;
        case 5:
            profileTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"出租费用" attributes:attrsDictionary];
            break;
        default:
            break;
    }
...
- (void)textFieldWithText:(UITextField *)textField
{
    switch (textField.tag) {
        case 0:
            _garageEstate = textField.text;
            break;
        case 1:
            _garageLoc = textField.text;
            break;
        case 2:
            _garageIsPrivate = textField.text;
            break;
        case 3:
            _garageType = textField.text;
            break;
        case 4:
            _garageIsRent = textField.text;
            break;
        case 5:
            _garageRentFee = textField.text;
            break;
        default:
            break;
    }
