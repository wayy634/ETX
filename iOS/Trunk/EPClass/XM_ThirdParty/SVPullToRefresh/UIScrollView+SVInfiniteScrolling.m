...
- (id)initWithFrame:(CGRect)frame {
    if(self = [super initWithFrame:frame]) {
        ...
        [nomalLable setTextColor:[LTools colorWithHexString:@"666666"]];
        [nomalLable setFont:K_FONT_SIZE(14)];
        ...
        [loadLabel setTextColor:[LTools colorWithHexString:@"666666"]];
        [loadLabel setFont:K_FONT_SIZE(14)];
